CREATE TABLE reels (
    ...
    title VARCHAR(255) DEFAULT NULL,          -- Title of the reel
...
(CONCAT('SRL', SUBSTRING(REPLACE(UUID(), '-', ''), 1, 29)), 'https://dcn39gthlx55v.cloudfront.net/shakti-reels/how can one acquire knowledge effectively.mp4', 'how can one acquire knowledge effectively');
